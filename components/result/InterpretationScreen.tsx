      ...
      <article className="interpretation-scroll" aria-labelledby="interpretationTitle">
        ...
        <section className="interpretation-story" aria-labelledby="storyTitle">
          ...
          <p>
            ...
            두 사람이 뒷문에서 도망 약속을 확인한 그 밤, 그 이야기는 무덕을 거쳐 춘월의 귀에 들어갔다.
          </p>
          <p>
            춘월은 돌쇠를 마음에 품고 있었다. 그러나 자신에게는 원치 않는 혼인이 다가오고 있었고,
            점순마저 돌쇠와 떠난다면 사랑도, 집안의 질서도, 자신의 체면도 모두 무너진다고 여겼다.
            그 두려움은 질투와 집착이 되어 점순을 향했다.
          </p>
          <p>
        ...
        <section className="interpretation-motive" aria-labelledby="motiveTitle">
          ...
          <blockquote>
            “그 아이가 떠나면 모든 것이 흐트러질 줄 알았습니다.
            돌쇠도, 이 집도, 제 이름도 모두요.”
          </blockquote>
          <p>
            춘월은 강요된 혼인 앞에서 자신의 삶을 통제할 수 없었다. 그래서 오히려 돌쇠와 점순의 삶을
            통제하려 했다. 점순을 죽인 까닭은 단순한 질투만이 아니었다. 돌쇠를 빼앗길 두려움,
            양반가 아씨로서의 체면, 무너지는 집안 질서를 붙들려는 집착이 한데 얽힌 결과였다.
