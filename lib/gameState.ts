...
export const routeInitialScreens = {
  ...
  "/magic-unlock-door": "magicUnlockDoor",
  ...
  "/space-station/briefing": "briefingScreen",
  "/space-station/airlock": "spaceAirlock",
  "/space-station/medical": "spaceMedicalBay",
  "/space-station/power": "spaceOxygenGenerator",
  "/space-station/data": "spaceDataCore",
  "/space-station/science": "spaceScienceLab",
  "/space-station/interrogation": "interrogationScreen",
