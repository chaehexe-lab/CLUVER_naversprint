  ...
  // 피해자: 직접 심문 대상은 아니지만, 모든 단서가 점순의 마지막 행적을 복원하게 합니다.
  {
    ...
    evidenceLinks: [
      ...
      },
      {
        ...
        evidenceName: "꽃 노리개",
        playerInference: "점순의 유품으로 다음 단서나 다음 꿈과 연결될 수 있다.",
        truth: "현재 사건의 직접 범인보다 점순의 사연과 이후 이야기로 이어지는 연결 아이템이다."
      }
    ],
    dialogueSamples: [
      {
  ...
  // 진범: 편지, 호패, 팔 상처가 모두 춘월에게 모이도록 설계된 인물입니다.
  {
    ...
    evidenceLinks: [
      ...
      },
      {
        ...
        truth: "점순과 돌쇠의 도망 계획을 막으려 한 감정적 동기를 보강한다."
      },
      {
        evidenceId: "marriage-letter",
        evidenceName: "혼인 서찰",
        playerInference: "춘월이 원치 않는 혼인 압박을 받고 있었을 수 있다.",
        truth: "춘월의 불안정한 처지와 통제 욕구를 보여 주지만, 범행을 정당화하지는 않는다."
      },
      {
    ...
    dialogueSamples: [
      ...
      },
      {
        ...
        line: "이 상처는... 처소의 문고리에 스친 것입니다. 그 이상은 모릅니다."
      },
      {
        trigger: "final-accusation",
        line: "그 아이가 떠나면 모든 것이 흐트러질 줄 알았습니다. 돌쇠도, 이 집도, 제 이름도 모두요."
      },
      {
        trigger: "small-footprint",
        line: "뒷문에 남은 발자국까지 제 것이라 하실 셈입니까?"
      }
    ]
  },
  // 핵심 목격자: 직접 본 장면보다 일기 기록으로 사건의 시간표를 이어 주는 인물입니다.
  {
    ...
    evidenceLinks: [
      ...
      },
      {
        ...
        truth: "진흙은 비슷하지만 발 크기와 무게감이 작은 발자국과 달라, 춘월 쪽 단서와 구분된다."
      },
      {
        evidenceId: "small-footprint",
        evidenceName: "작은 발자국",
