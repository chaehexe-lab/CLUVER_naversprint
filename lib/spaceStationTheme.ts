...
export const spaceStationTheme = {
  ...
  suspects: [
    { id: "harry", name: "해리", role: "데이터 시스템 관리자", authId: "ORBIT-13-DAT-0319", scene: room, sprite: "/assets/space-station/characters/harry-upper-transparent.png", sleeveScene: "/assets/space-station/characters/harry-upper-transparent.png", resultImage: "/assets/space-station/characters/harry-upper.webp", resultLayout: { slot: { left: "13.22%", top: "38.5%", width: "13.5%", height: "30%" }, nameLeft: "19.9%", stampLeft: "23.8%", offsetX: "0%" }, hiddenTruth: "21시 43분경 메르스에게 키카드를 빌려줬다." },
    { id: "mers", name: "메르스", role: "의료 책임자", authId: "ORBIT-13-MED-0427", scene: room, sprite: "/assets/space-station/characters/mers-upper-transparent.png", sleeveScene: "/assets/space-station/characters/mers-upper-transparent.png", resultImage: "/assets/space-station/characters/mers-upper.webp", resultLayout: { slot: { left: "32.78%", top: "37%", width: "13.5%", height: "31%" }, nameLeft: "39.5%", stampLeft: "43.4%", offsetX: "0%" }, hiddenTruth: "불법 임상시험과 약물 부작용을 숨기고 연구 보상과 우선 귀환 특혜를 지키려 데이비드를 살해했다." },
    { id: "aladdindin", name: "알라딘딘", role: "정비 담당 엔지니어", authId: "ORBIT-13-ENG-0821", scene: room, sprite: "/assets/space-station/characters/aladdindin-upper-transparent.png", sleeveScene: "/assets/space-station/characters/aladdindin-upper-transparent.png", resultImage: "/assets/space-station/characters/aladdindin-upper.webp", resultLayout: { slot: { left: "52.57%", top: "37.8%", width: "13.5%", height: "30.4%" }, nameLeft: "59.3%", stampLeft: "63.2%", offsetX: "0%" }, hiddenTruth: "22시 11분경 에어록 근처에서 메르스의 수상한 무전을 들었다." },
    { id: "einspanner", name: "아인슈페너", role: "생명과학 연구원", authId: "ORBIT-13-SCI-0516", scene: room, sprite: "/assets/space-station/characters/einspanner-upper-transparent.png", sleeveScene: "/assets/space-station/characters/einspanner-upper-transparent.png", resultImage: "/assets/space-station/characters/einspanner-upper.webp", resultLayout: { slot: { left: "72.01%", top: "38.2%", width: "13.5%", height: "30%" }, nameLeft: "78.7%", stampLeft: "82.6%", offsetX: "0%" }, hiddenTruth: "21시 47분경 메르스가 약물 냉각 보관함을 의료실로 운반하는 모습을 목격했다." }
  ],
  locations: [
