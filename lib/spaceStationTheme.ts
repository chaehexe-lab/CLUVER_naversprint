...
export const spaceStationTheme = {
  ...
  suspects: [
    { id: "harry", name: "해리", role: "데이터/통신 담당", authId: "ORBIT-13-DAT-0319", scene: room, sprite: "/assets/space-station/characters/harry-upper-transparent.png", sleeveScene: "/assets/space-station/characters/harry-upper-transparent.png", resultImage: "/assets/space-station/characters/harry-upper.webp", resultLayout: { slot: { left: "13.22%", top: "38.5%", width: "13.5%", height: "30%" }, nameLeft: "19.9%", stampLeft: "23.8%", offsetX: "0%" }, hiddenTruth: "21시 43분경 메르스에게 키카드를 빌려줬다." },
    ...
    { id: "aladdindin", name: "알라딘딘", role: "외부 작업 장비 담당 엔지니어", authId: "ORBIT-13-ENG-0821", scene: room, sprite: "/assets/space-station/characters/aladdindin-upper-transparent.png", sleeveScene: "/assets/space-station/characters/aladdindin-upper-transparent.png", resultImage: "/assets/space-station/characters/aladdindin-upper.webp", resultLayout: { slot: { left: "52.57%", top: "37.8%", width: "13.5%", height: "30.4%" }, nameLeft: "59.3%", stampLeft: "63.2%", offsetX: "0%" }, hiddenTruth: "22시 11분경 에어록 근처에서 메르스의 수상한 무전을 들었다." },
