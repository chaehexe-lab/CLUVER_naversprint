...
export const evidenceCatalog = [
  ...
  {
    name: "찢어진 옷고름",
    aliases: ["옷고름", "목끈", "찢긴 끈", "비단 끈", "춘월 옷고름", "목을 조른 흔적"]
  },
  {
    name: "긁힌 팔 흔적",
...
export const suspectPersonas: SuspectPersona[] = [
  {
    ...
    evidenceReactions: [
      ...
      },
      {
        ...
        responseGuide: "처음엔 편지는 집안 어디에나 있다고 둘러대지만, 편지 말투가 돌쇠답지 않고 지나치게 정중하다는 말에는 당황한다. 서찰을 본 적은 없다고 버티되, 점순이 왜 창고로 갔는지 묻는 말에는 말이 흔들린다."
      },
      {
      ...
      },
      {
        ...
        responseGuide: "팔의 긁힌 자국이나 찢어진 옷고름 이야기가 나오면 즉시 소매와 옷깃을 의식하며 당황한다. 옷고름은 자기 것이 아니라고 말하지만, 고급 비단 재질과 향을 묻는 말에는 대답이 끊긴다."
      }
    ],
    breakEvidenceNames: ["찢어진 약속 편지", "찢어진 옷고름", "긁힌 팔 흔적", "작은 발자국", "돌쇠의 그림"],
    finalBehavior: "결정적 증거가 쌓이면 처음엔 시대와 혼인을 탓하다가, 점순이 돌쇠를 빼앗아 갔다는 감정을 드러낸다. 완전한 자백 전에도 약속 편지, 찢어진 옷고름, 팔의 상처를 더 살피라는 단서가 나오게 한다."
  },
  {
    id: "dolsoe",
    name: "돌쇠",
