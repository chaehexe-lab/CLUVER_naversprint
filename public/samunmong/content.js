window.SAMUNMONG_CONTENT = {
  ...
  evidenceData: {
    ...
    "나무 상자": { note: "사랑방에서 확인한 작은 나무 상자. 안에 무엇이 있었는지 확인해야 한다.", img: "/samunmong/assets/evidence-transparent/evidence-wooden-box-transparent.png", tool: "돋보기", toolResult: "틈새를 자세히 살피자 상자 안쪽에 잘게 부서진 종이 가루가 남아 있다." },
    "무덕의 번진 일기": { note: "먹이 번져 읽기 어려운 일기. 숨긴 문장을 추적할 수 있다.", img: "/samunmong/assets/mudeok-interaction/evidence-mudeok-smeared-diary.png", tool: "촛불 비추기", toolResult: "빛을 비추자 번진 먹 아래로 최근에 젖은 듯한 얼룩 경계가 드러난다." },
    ...
    "하인 장부": { note: "하인들의 출입과 심부름 기록을 적은 장부.", img: "/samunmong/assets/evidence-transparent/evidence-servant-ledger.png", tool: "촛불 비추기", toolResult: "빛에 비추자 장부장 사이로 눌려 있던 빈 줄 하나가 드러난다." },
    ...
    "먹가루": { note: "책상 주변에 흩어진 먹가루. 문서가 급히 지워졌는지 확인할 수 있다.", img: "/samunmong/assets/evidence-transparent/evidence-ink-powder.png", tool: "돋보기", toolResult: "확대해 보니 가루가 문지른 자국을 따라 고르게 흩어져 있다." },
    ...
    "낡은 칼": { note: "돌쇠 처소에서 확인한 오래된 칼. 직접 증거보다 사용 흔적을 조사해야 한다.", img: "/samunmong/assets/evidence-transparent/evidence-axe-knife.png", tool: "돋보기", toolResult: "날 가장자리에 오래된 얼룩과 새 얼룩이 섞인 듯한 흔적이 보인다." },
    "피 묻은 붕대": { note: "피로 보이는 얼룩이 남은 붕대. 상처의 흔적과 연결될 수 있다.", img: "/samunmong/assets/evidence-transparent/evidence-bloodied-bandage.png", tool: "돋보기", toolResult: "얼룩 가장자리가 아직 짙고 불규칙하게 번진 흔적이 보인다." },
    "도망 보따리": { note: "급히 싼 보따리. 누군가 떠날 준비를 했는지 확인해야 한다.", img: "/samunmong/assets/evidence-transparent/evidence-escape-bundle.png", tool: "돋보기", toolResult: "묶음 틈을 살피자 안쪽에 접힌 종이 조각이 끼어 있다." },
    ...
    "맞물리는 종이 조각": { note: "다른 문서 조각과 맞물릴 수 있는 종이 조각.", img: "/samunmong/assets/evidence-transparent/evidence-matching-paper-scraps.png", tool: "촛불 비추기", toolResult: "빛 아래에서 가장자리를 맞춰 보니 찢어진 결이 자연스럽게 이어진다." },
