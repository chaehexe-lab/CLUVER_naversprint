window.SAMUNMONG_CONTENT = {
  ...
  evidenceData: {
    "호패 조각": {
      ...
      questions: ["이 호패를 잃어버린 적 있습니까?", "누가 당신 호패를 만질 수 있었습니까?", "사건 전날 호패를 마지막으로 본 때가 언제입니까?"],
    ...
    "돌쇠의 그림": {
      ...
      questions: ["이 그림의 인물이 누구입니까?", "왜 이 그림을 숨겨 두었습니까?", "돌쇠와 점순의 사이를 알고 있었습니까?"],
    ...
    "사라진 노리개": {
      ...
      relatedSuspects: ["춘월"],
      questions: ["노리개가 언제부터 보이지 않았습니까?", "사건 전날 이 장신구를 하고 있었습니까?", "누군가 당신 방에 들어온 적이 있습니까?"],
    ...
    "나무 상자": {
      ...
      questions: ["이 상자에는 원래 무엇이 들어 있었습니까?", "마지막으로 상자를 연 사람은 누구입니까?", "하인들이 이 상자를 만질 수 있었습니까?"],
    ...
    "무덕의 번진 일기": {
      ...
      questions: ["6월 29일 사랑방에서 누구 목소리가 났습니까?", "6월 30일 밤 점순을 보러 온 사람을 보았습니까?", "7월 1일 춘월 아씨가 무엇을 숨겼습니까?"],
    ...
    "진흙 묻은 짚신": {
      ...
      questions: ["이 짚신은 누구의 것입니까?", "6월 30일 밤 뒷문 근처에 간 적이 있습니까?", "점순이 나간 뒤 따라간 사람이 있었습니까?"],
    ...
    "찢어진 옷고름": {
      ...
      questions: ["이 옷고름과 같은 옷을 본 적 있습니까?", "점순이와 몸싸움을 한 사람이 있었습니까?", "소매나 손에 긁힌 흔적이 있는지 확인해도 되겠습니까?"],
    ...
    "손톱 밑 실타래": {
      ...
      relatedSuspects: ["춘월"],
      questions: ["점순의 손에 남은 실과 같은 옷감이 있습니까?", "사건 뒤 옷을 갈아입은 사람이 있습니까?", "소매 아래 상처를 확인해도 되겠습니까?"],
    ...
    "점순 목 검안 종이": {
      ...
      questions: ["점순의 목에 어떤 흔적이 있었습니까?", "칼에 베인 상처가 아니라면 어떤 다툼이 있었습니까?", "현장에서 저항 흔적을 보았습니까?"],
    ...
    "빈 호패 주머니": {
      ...
      questions: ["호패 주머니가 빈 것을 언제 알았습니까?", "누가 사랑방에 드나들 수 있었습니까?", "호패를 잃어버렸다면 왜 바로 말하지 않았습니까?"],
    ...
    "하인 장부": {
      ...
      questions: ["사건 전날 사랑방 심부름을 한 사람은 누구입니까?", "춘월 아씨 쪽 심부름 기록이 있습니까?", "비어 있는 줄에는 무엇이 적혀 있었습니까?"],
    ...
    "종이칼": {
      ...
      relatedSuspects: ["유문석", "춘월"],
      questions: ["이 종이칼을 누가 자주 씁니까?", "찢어진 문서 조각의 가장자리와 비교해도 되겠습니까?", "사건 전날 편지를 자르거나 태운 적이 있습니까?"],
    ...
    "먹가루": {
      ...
      relatedSuspects: ["유문석", "춘월"],
      questions: ["최근 지운 글씨가 있었습니까?", "누가 책상 주변을 급히 정리했습니까?", "문서의 글귀를 지운 이유가 있습니까?"],
    ...
    "혼서 조각": {
      ...
      questions: ["이 혼서가 언제 오갔습니까?", "춘월 아씨는 이 혼인을 원했습니까?", "혼인을 피하려는 사람이 있었습니까?"],
    ...
    "낡은 칼": {
      ...
      relatedSuspects: ["돌쇠"],
      questions: ["이 칼을 사건 전날 사용했습니까?", "점순과 도망치려 했다면 왜 무기를 챙겼습니까?", "칼의 얼룩이 새것인지 오래된 것인지 설명할 수 있습니까?"],
    ...
    "피 묻은 붕대": {
      ...
      relatedSuspects: ["돌쇠"],
      questions: ["이 붕대는 누구 상처에 쓴 것입니까?", "사건 당일 다친 적이 있습니까?", "점순과 만난 뒤 붕대를 감은 이유가 있습니까?"],
    ...
    "도망 보따리": {
      ...
      questions: ["점순과 떠날 계획이 있었습니까?", "그 계획을 누구에게 들켰습니까?", "6월 30일 밤 점순을 만났습니까?"],
    ...
    "작은 발자국": {
      ...
      relatedSuspects: ["춘월", "무덕"],
      questions: ["사건 전날 뒷문을 지난 적이 있습니까?", "이 발자국이 남성의 짚신으로 보입니까?", "춘월 아씨가 밤에 밖으로 나간 적이 있습니까?"],
    ...
    "끊어진 호패끈": {
      ...
      relatedSuspects: ["유문석", "춘월"],
      questions: ["호패끈이 왜 뒷문 쪽에 있었습니까?", "끈이 저절로 끊어진 것처럼 보입니까?", "호패를 들고 뒷문을 지난 사람이 있었습니까?"],
    ...
    "맞물리는 종이 조각": {
      ...
      questions: ["이 조각과 맞는 편지를 본 적 있습니까?", "점순에게 창고로 오라는 말을 한 사람이 누구입니까?", "편지의 말투가 돌쇠의 것과 같습니까?"],
    ...
    "찢어진 문서 조각": {
      ...
      questions: ["이 편지의 글씨를 알아보겠습니까?", "점순이 이 쪽지를 누구에게서 받았다고 믿었습니까?", "창고에서 기다리라는 약속을 알고 있었습니까?"],
    ...
    "긁힌 팔 흔적": {
      ...
      relatedSuspects: ["춘월"],
      questions: ["팔의 긁힌 자국은 언제 생겼습니까?", "점순과 몸싸움을 한 적이 없다고 확실히 말할 수 있습니까?", "이 상처 주변의 실오라기는 어디서 묻었습니까?"],
